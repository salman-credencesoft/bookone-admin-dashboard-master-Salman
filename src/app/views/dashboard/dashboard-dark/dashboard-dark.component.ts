...
export class DashboardDarkComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
      setTimeout(() => {
        this.layout.publishLayoutChange({sidebarColor: 'dark-blue', topbarColor: 'dark-blue'});
        this.scack.open('Layout option changed to {sidebarColor: "dark-blue", topbarColor: "dark-blue"};', 'OK', {duration: 6000})
      });
    ...
    ngOnDestroy() {
      setTimeout(() => {
        this.layout.publishLayoutChange({sidebarColor: 'white', topbarColor: 'white'});
        this.scack.open('Layout option changed {sidebarColor: "white", topbarColor: "white"};', 'OK', {duration: 6000})
