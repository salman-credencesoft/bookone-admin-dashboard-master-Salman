...
export class NavigationService {
  ...
  iconMenu: IMenuItem[] = [
    ...
    },
    {
      ...
      type: "dropDown",
      tooltip: "Rates & Availability",
      icon: "event_available",
      state: "bookone",
      sub: [
        { name: "Manage Rates & Availability", state: "manage-rates-availability" },
    ...
    },
    {
      ...
      state: "bookone",
      sub: [
        { name: "Manage Payment", state: "manage-payment" }
      ]
    },
    {
      name: "Expense",
      ...
      state: "bookone",
      sub: [
        { name: "Manage Expense", state: "manage-expense" }
      ]
    },
    // {
    //   name: "CRUD Table",
